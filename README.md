...
# RipGrep
<img src="pictures/image-20220216183845205.png" width="880" height="480" />

<img src="pictures/image-20220216184135956.png" width="880" height="480" />
...
# FZF
<img src="pictures/image-20220216184612173.png" width="880" height="480" />
...
<img src="https://flameshot.org/img/flameshot-demo.gif" width="880" height="480" />
...
<img src="pictures/guake.png" width="880" height="480" />
...
## Название приложения (заголовок 2)

Скриншот интерфейса (закинуть в pictures)

Ссылка на Github

Краткое описание: “такая-то утилита делает такие штуки”

Какие проблемы решает: bullet list

-   Ускоряет набор текста
-   Уменьшает риск опечаток
-   Делает бочку